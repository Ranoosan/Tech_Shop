...
namespace w2
{
    public partial class AddProduct2 : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "INSERT INTO Products2 (ProductName, Category, Brand, RAMCapacity, ROMCapacity, Price, Description, ImageUrl) " +
            ...
            Response.Redirect("supplier2.aspx"); // Redirect to a page that lists products after adding
        }
    }
}
