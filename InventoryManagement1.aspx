<%@ Page Title="Inventory Management" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="InventoryManagement1.aspx.cs" Inherits="w2.InventoryManagement1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
          <div class="navbar-title">
                <h1>FutureTech Supplies</h1> 
            </div>
        <ul class="nav-links">
            <li><a href="supplier2.aspx">Home</a></li>
            <li><a href="InventoryManagement1.aspx">Inventory</a></li>
            <li><a href="ViewSupplier2Orders.aspx">Orders</a></li>
        </ul>
    </div>
</nav>
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Button ID="btnAddProduct" runat="server" Text="Add Product" OnClick="btnAddProduct_Click" CssClass="btn" />
                                ...
                                <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("ProductID2") %>' CssClass="button-link" OnClientClick="return confirm('Are you sure you want to delete this product?');" />
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
