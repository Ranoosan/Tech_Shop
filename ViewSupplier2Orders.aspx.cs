...
namespace w2
{
    public partial class ViewSupplier2Orders : Page
    {
        ...
        private void LoadOrders()
        {
            ...
            string query = "SELECT OrderID, ProductID, Quantity, CustomerName, CustomerEmail, OrderDate, Status FROM Orders2 WHERE Supplier = 'Supplier2'";
